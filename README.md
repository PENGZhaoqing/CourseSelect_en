...
This sample system is an extended english version of CourseSelect [Original Version](https://github.com/PENGZhaoqing/CourseSelect), which is developed for the UCAS master course (Senior Software Engineering).

This app is aimed to help beginners to learn RoR (Ruby on Rails).
